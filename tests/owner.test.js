...
test.describe.parallel('Tests by OWNER', () => {
  ...
  test('Case #05 Add new ticket, with product and assignee to OWNER', async ({
    ticketsPage,
    ticketPage,
    newTicketPage,
  }) => {
  ...
  test('Case #06 Add new ticket, with product and assignee to STAFF', async ({
    ticketsPage,
    ticketPage,
    newTicketPage,
  }) => {
  ...
  test('Case #07 Add new ticket behalf staff', async ({
    ticketsPage,
    ticketPage,
    newTicketPage,
  }) => {
  ...
  test('Case #08 Add new ticket behalf consumer no product, no assignee', async ({
    ticketsPage,
    ticketPage,
    newTicketPage,
  }) => {
  ...
  test('Case #09 Add new ticket behalf consumer no product, with assignee', async ({
    ticketsPage,
    ticketPage,
    newTicketPage,
  }) => {
  ...
  // test('Case #10 Add new ticket behalf consumer with product, no assignee', async ({
  //   ticketsPage,
  //   ticketPage,
  //   newTicketPage,
  // }) => {
